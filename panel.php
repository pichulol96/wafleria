...
<head>
    ...
    <link href="/wafleria/plugins/bootstrap/bootstrap.min.css" rel="stylesheet">
    <script src="/wafleria/plugins/bootstrap/bootstrap.bundle.min.js"></script>
    <title>Panel Administrativo</title>
    <script src="/wafleria/plugins/sweetalert2/sweetalert2.all.min.js"></script>
    <link rel="stylesheet" href="/wafleria/plugins/sweetalert2/sweetalert2.min.css">
    <style>
        .icon-delete{
            width: 15px;
        }
